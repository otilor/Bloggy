<?php 
	...
	$sql = "SELECT email, user_posts FROM post ORDER BY posted_at";
							...
							<div class="row">
								<div class="col">
									...
									<div class="home_slider_content">
										...
										<div class="home_slider_item_category trans_200"><a href="category.php" class="trans_200"><?php echo htmlspecialchars($post["email"]); ?></a></div>
										<?php foreach(explode(",",$post["user_posts"]) as $ind_post):?>
										<div class="home_slider_item_title">
											<a href="post.php"><?php echo htmlspecialchars($ind_post);?></a>
										</div>
										<?php endforeach?>
			...
			<div class="row row-lg-eq-height">
				<div class="col-lg-9 order-lg-1 order-2">
					<div class="footer_content">
						<div class="footer_logo"><a href="#">Bloggy</a></div>
